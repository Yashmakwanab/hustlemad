        ...
        <div className='order-first lg:order-last'>
          {value === 'Our Services' ?
            <div className={`text-center lg:text-start transition duration-300`}>
              <h2 className='text-[24px] sm:text-[40px] lg:text-[48px] xl:text-[52px] font-[900] leading-[27px] sm:leading-[46px] lg:leading-[55px] xl:leading-[60px] text-[#0F143A] mb-2 sm:mb-3 lg:mb-4 xl:mb-6'>Our Services</h2>
              <p className='text-[14px] sm:text-[20px] xl:text-[24px] 3xl:text-[28px] font-[400] leading-[19px] sm:leading-[27px] xl:leading-[32px] 3xl:leading-[38px] text-[#0F143A] opacity-[72%] mb-4 sm:mb-9 lg:mb-10'>We make the process of finding & acquiring the best Swags for your team easy.</p>
              <img src='/Images/landingPage/serviceImage.png' alt="our services" className='w-[200px] sm:w-[240px] lg:w-[300px] 2xl:w-[332px] 3xl:w-[372px] absolute bottom-0 left-1/2 transform -translate-x-1/2 lg:-translate-x-0' />
            </div>
            :
            <>
              {Services.map((Service, index) => (
