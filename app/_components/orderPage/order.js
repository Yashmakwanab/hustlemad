    ...
    return (
        <>
            ...
            <div>
                ...
                <div className="z-[99999999] bg-[#0F143A] pt-[16px] pb-[8px] sm:pt-[20px] sm:pb-[20px] px-[32px] flex items-center justify-center top-[45px] md:top-[127px] nxl:top-[80px] right-0 block lg:hidden fixed cursor-pointer w-full sm:w-auto rounded-b-[12px] sm:rounded-bl-[12px] sm:!rounded-br-none" onClick={() => setShowCart(!showCart)}>
                ...
                {showCart && <div className=""><Cartpage setShowCart={setShowCart} /></div>}
            </div>
        </>
    );
}
