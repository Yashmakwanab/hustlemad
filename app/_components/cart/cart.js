                        ...
                        <div key={index} className='flex border-b-[1px] pt-[13px] pb-[9px] px-[12px] justify-between'>
                            <div className='flex'>
                                <div className='mr-[20px]'>
                                    <ImageWrapper src={item.image} alt='img' className='w-[72px] h-[60px]' />
                                </div>
                                <div className='mr-[12px]'>
                                    <div className='text-[#0F143A] font-mazzardSemiBold text-[14px] leading-[14px] mb-[10px] w-[174px]'>{item.title.substring(0, 22)}...</div>
                                    <div className='text-[#0F143A] font-mazzardMedium text-[12px] leading-[12px] mb-[6px] opacity-90'><span className='font-[600] opacity-80'>₹ </span>{item.price}</div>
                                    <div className='text-[#0F143A] font-mazzardMedium text-[12px] leading-[12px] opacity-90'>{item.category}</div>
                                </div>
                            </div>
            ...
            <div className='mt-[40px]'>
                <div className='border-b-[1px] px-[18px]'>
                    <div className='flex items-center justify-between mb-[10px]'>
                        <div className='text-[#0F143A] font-mazzardMedium text-[16px] leading-[18px]'>Quantity<span className='text-[#0F143A] font-mazzardMedium text-[12px] leading-[14px] opacity-90 ml-[6px]'>( 30 min. )</span></div>
                    ...
                    <div className='flex items-center justify-between mb-[14px]'>
                        <div className='text-[#0F143A] font-mazzardMedium text-[16px] leading-[18px]'>Price<span className='text-[#0F143A] font-mazzardMedium text-[12px] leading-[14px] opacity-90 ml-[6px]'>( per pack )</span></div>
                        <div className='text-[#343434CC] font-mazzardSemiBold text-[10px] leading-[12px]'><span className='text-[#0F143A] font-mazzardSemiBold text-[14px] leading-[16px]'><span className='font-[600]'>₹ </span>{pricePerPack.toFixed(2)}</span> + <span>TBD</span></div>
                    </div>
                </div>
                <div className='px-[18px]'>
                    <div className='flex items-center justify-between mt-[14px] mb-[28px]'>
                        <div className='text-[#0F143A] font-mazzardMedium text-[16px] leading-[18px]'>Total Estimate</div>
